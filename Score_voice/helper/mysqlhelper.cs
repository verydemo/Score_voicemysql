...
namespace Score_voice
{
    public abstract class MySqlHelper
    {
        ...
        //public static string Conn = "server=172.29.83.44;UId=root;PassWord=123456;Persist Security Info=True;database=AIScore;Charset=utf8;";
        public static System.Configuration.Configuration config1 = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.None);
        public static string Conn = config1.AppSettings.Settings["sqlConnstring"].Value;
